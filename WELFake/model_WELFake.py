...
# Load the dataset
df = pd.read_csv(r'C:\Users\navya\OneDrive\Desktop\FakeNews Project\WELFake\WELFake.csv')

# Print column names to see what's available
print("Available columns:", df.columns.tolist())

# Combine title and text (assuming they are named 'title' and 'text' in the dataset)
df['combined_text'] = df['title'] + ' ' + df['text']

# Prepare features and target (assuming 'label' is the target column)
X = df['combined_text']
y = df['label']
...
output_dir = r'C:\Users\navya\OneDrive\Desktop\FakeNews Project\WELFake'
